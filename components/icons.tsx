import { Code2, Mail, MapPin, Phone, Trophy, type LucideProps } from "lucide-react";

type IconProps = LucideProps;

// lucide-react in this project has no brand marks, so GitHub / LinkedIn are inlined.
export function GithubMark({ className, ...props }: React.SVGProps<SVGSVGElement> & { className?: string }) {
  return (
...
export function LinkedinMark({ className, ...props }: React.SVGProps<SVGSVGElement> & { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className} {...props}>
